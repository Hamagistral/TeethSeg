...
function Header() {
  ...
  return (
    <div className="header flex-box h-20 md:h-full justify-between w-full px-8 lg:px-60 bg-slate-900 text-center">
      <div className="header fixed-top flex-box justify-between w-full py-2 bg-slate-900 text-center">
        ...
        >
          <Menu />
          <div className="absolute top-20 left-0 bg-slate-900 flex-box flex-col pb-8 w-full">
            {menuOpen ? (
              <>
                {" "}
                <MenuItems /> <Sign />
