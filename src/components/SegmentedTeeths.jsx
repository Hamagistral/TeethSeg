...
const SegmentedTeeths = () => {
    ...
    loadVTPTest('/TeethsSegmented.vtp', "MaterialIds")

    return (
        <div className='absolute top-0 right-0'>
            <div id="teeth-segmented"></div>
        </div>
    )
};

export default SegmentedTeeths;
