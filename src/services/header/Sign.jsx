		...
		<>
			{!user ? (
				...
				<>
					...
					>
						<span className="text-white flex-box text-base font-semibold  transition ease-linear leading-tight relative px-6 py-4 bg-slate-900 rounded items-start gap-3 group-hover:bg-opacity-0 whitespace-nowrap">
							Log Out 
						</span>
					</button>
				</>
