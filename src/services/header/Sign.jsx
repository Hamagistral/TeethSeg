	...
	return (
		<>
			{!user ? (
				...
				>
					<div className="px-6 py-3 transition ease-linear bg-background text-foreground bg-opacity-25 rounded-lg justify-start items-start gap-2.5 inline-flex hover:bg-slate-100 hover:text-slate-900">
