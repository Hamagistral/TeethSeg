	...
	return (
		<>
			{!user ? (
				...
				>
					<div className="px-6 py-3 transition ease-linear text-white bg-slate-500 bg-opacity-25 rounded-lg justify-start items-start gap-2.5 inline-flex hover:bg-slate-100 hover:text-slate-900">
				...
				<>
					...
					>
						<span className="text-white flex-box text-base font-semibold  transition ease-linear leading-tight relative px-6 py-3 bg-slate-900 rounded items-start gap-3 group-hover:bg-opacity-0 whitespace-nowrap">
							Log Out 
						</span>
					</button>
				</>
