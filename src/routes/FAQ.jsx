...
const Faq = () => {
	const AccordionItem = ({ header, text }) => {
		...
		return (
			<div className="single-faq mb-8 w-full text-muted-foreground rounded-lg border bg-muted/80 p-4 sm:p-8 lg:px-6 xl:px-8">
				<button
				...
				<div className="absolute bottom-0 right-0 z-[-1]">
					...
					>
						...
						<defs>
							...
							>
								<stop stopColor="#3056D3" stopOpacity="0.4" />
								<stop
									offset="1"
									stopColor="#3056D3"
									stopOpacity="0"
